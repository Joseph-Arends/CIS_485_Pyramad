...
public class ElevatorGoDown : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isMoving == true)
        {
            ...
            elevator.gameObject.transform.position = Vector3.Lerp(elevator.gameObject.transform.position, bottom.position, step);
            //transform.Translate(Vector3.up * Time.deltaTime);
        }
        if (elevator.gameObject.transform.localPosition.y <= bottom.localPosition.y)
        {
            isMoving = false;
        }
